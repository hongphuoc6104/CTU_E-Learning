...
- `docs/expansion/PROJECT_EXPANSION_MASTER_EXECUTION_PROMPT.md` keeps the reusable execution prompt.
- `docs/expansion/PROJECT_EXPANSION_PLAN_INDEX.md` is the master roadmap.
- `docs/expansion/completed/` stores completed expansion plans.
