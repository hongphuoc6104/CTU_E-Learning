    ...
    <div class="col-sm-6">
      <form class="mt-5 mx-5" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="inputnewpassword" placeholder="Nhập mật khẩu mới" name="stuNewPass">
        </div>
        <button type="submit" class="btn btn-primary mr-4 mt-4" name="stuPassUpdateBtn">Cập nhật</button>
        <button type="reset" class="btn btn-secondary mt-4">Đặt lại</button>
